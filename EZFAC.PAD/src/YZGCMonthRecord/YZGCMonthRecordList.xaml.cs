...
namespace EZFAC.PAD
{
    ...
    /// </summary>
    public sealed partial class YZGCMonthRecordList : Page
    {
        ...
        private void onLookClick(object sender, RoutedEventArgs e)
        {
            ...
            // 获取信息详情
            Dictionary<string, string> getData = YZGCMonthService.getDetail(lvFiles.Items[courrent].ToString());
            ...
            // 导航并传递参数
            this.Frame.Navigate(typeof(YZGCMonthRecordDetail), getData);
        }
        ...
        private async void Confirm_Click(object sender, RoutedEventArgs e)
        {
            if (lvFiles.SelectedItems.Count > 0)
            {
                ...
                //  审批所选信息
                YZGCMonthService.mulYZGCMonth(lvFiles, checkerInfo, data["folderName"]);
                // 设置提示框
        ...
        private void refresh_Click(object sender, RoutedEventArgs e)
        {
            ...
            dataInfo.getInfo("YZGC_MONTH_RECORD", (int.Parse(data["userlevel"]) - 1).ToString(), data["folderName"], dialog);
        }
