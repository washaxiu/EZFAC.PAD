...
namespace EZFAC.PAD
{
    ...
    /// </summary>
    public sealed partial class MaintenanceLogList : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter != null && e.Parameter is Dictionary<string, string>)
            {
                ...
                // 获取审批信息列表
                MaintenanceLogService.getMaintenanceLogList(lvFiles, data["userlevel"], data["folderName"]);
            }
        ...
        private async void Confirm_Click(object sender, RoutedEventArgs e)
        {
            if (lvFiles.SelectedItems.Count > 0)
            {
                ...
                //  审批所选信息
                MaintenanceLogService.mulMaintenanceLog(lvFiles, checkerInfo, data["folderName"]);
                // 设置提示框
        ...
        private void onLookClick(object sender, RoutedEventArgs e)
        {
            ...
            // 获取信息详情
            Dictionary<string, string> getData = MaintenanceLogService.getDetail(lvFiles.Items[courrent].ToString());
        ...
        private void refresh_Click(object sender, RoutedEventArgs e)
        {
            ...
            dataInfo.getInfo("MAINTENANCE_LOG", (int.Parse(data["userlevel"]) - 1).ToString(), data["folderName"], dialog);
        }
