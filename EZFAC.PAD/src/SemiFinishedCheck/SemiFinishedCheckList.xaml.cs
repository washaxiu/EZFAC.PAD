    ...
    public sealed partial class SemiFinishedCheckList : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter != null && e.Parameter is Dictionary<string, string>)
            {
                ...
                // 获取审批信息列表
                semiFinishedCheckService.getApprovalList(lvFiles, data["userlevel"], data["floderName"]);
            }
        ...
        private async void Confirm_Click(object sender, RoutedEventArgs e)
        {
            if (lvFiles.SelectedItems.Count > 0)
            {
                ...
                //  审批所选信息
                semiFinishedCheckService.mulApproval(lvFiles, checkerInfo, data["floderName"]);
                // 设置提示框
