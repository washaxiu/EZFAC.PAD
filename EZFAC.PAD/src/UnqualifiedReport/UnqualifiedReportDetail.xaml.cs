    ...
    public sealed partial class UnqualifiedReportDetail : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter != null && e.Parameter is Dictionary<string, string>)
            {
                ...
                // 获取审批信息并回填
                unqualifiedReportService.getApprovalDetail("UnqualifiedReport",data["fileName"], textBox, calendarDatePicker, radioButton);
            }
        ...
        {
            StorageFolder folder = await KnownFolders.PicturesLibrary.CreateFolderAsync("UnqualifiedReport", CreationCollisionOption.OpenIfExists);
            if (folder != null)
            {
                ...
                if (file != null)
                {
                    ...
                    commonOperation.writeJsonToFile(jsonObject, data["fileName"], KnownFolders.PicturesLibrary, "UnqualifiedReport");
                }
            }
