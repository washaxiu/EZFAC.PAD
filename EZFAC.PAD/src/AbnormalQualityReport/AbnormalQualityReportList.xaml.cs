...
namespace EZFAC.PAD
{
    ...
    /// </summary>
    public sealed partial class AbnormalQualityReportList : Page
    {
        ...
        public AbnormalQualityReportList()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter != null && e.Parameter is Dictionary<string, string>)
            {
                ...
                newAdd.IsEnabled = data["userlevel"] == "2" ;
            }
        ...
        private void onLookClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                // 导航并传递参数
                this.Frame.Navigate(typeof(AbnormalQualityReportOne), getData);
            }
            else
            {
                this.Frame.Navigate(typeof(AbnormalQualityReportTwo), getData);
            }
        }
